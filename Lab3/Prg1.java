...
public class Prg1 {
    public static void main(String[] args) {
        ...
        HourlyEmployee hourlyEmployee = new HourlyEmployee(1, "John Doe", "Teaching Assistant", 20.5, 40);
        SalariedEmployee salariedEmployee = new SalariedEmployee(2, "Jane Smith", "Lecturer", 5000);
        ExecutiveEmployee executiveEmployee = new ExecutiveEmployee(3, "Michael Brown", "Dean", 10000, 15);
